...
'''
import unittest
from auto_correction.selection.autocheck_selection_strategy_pending_and_runnable import AutocheckSelectionStrategyPendingAndRunnable
...
class TestAutocheckSelectionStrategy(unittest.TestCase):
    ...
    def testAutocheckSelectionStrategyShouldInvokeAutocheckFilterMethod(self):
        ...
        autocheck_selection_strategy.list_filter = Mock()
        ...
        autocheck_selection_strategy.list_filter.filter.assert_any_call()

...
# Fill it in
scp -r /usr/local/lib/pharo/pharo-wk ./workdir
...
echo "Smalltalk exitSuccess" >> test.st
echo "" >> test.st
# file generated
...
# I build the command
command="./NBCog -headless -noevents ./pharo-2.0/Pharo-2.0.image $concatenated_list"
# And the invoke it
$command

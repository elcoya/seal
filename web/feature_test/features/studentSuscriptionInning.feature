Feature: As a student I want to aplicate to a course
	...
	Scenario: See the list of old suscription order by suscription date
	   Given student "martin" exists with password "martin"
		 ...
		 And a inning with name "tarde" and description "horario" in the course "2012-1"
		 And a inning with name "noche" and description "horario" in the course "2013-1"
		 And there are no suscription
		 ...
		 And existe suscrition of student "martin" for course "2013-1" inning "noche" with suscription date "2013-11-02" and state "Pending"
	     And I log in as "martin" "martin"
	    When I click in the "Suscription" link
    ...
    Scenario: See the list of accept suscription
	   Given student "martin" exists with password "martin"
		 ...
		 And a inning with name "tarde" and description "horario" in the course "2012-1"
		 And there are no suscription
		 And existe suscrition of student "martin" for course "2012-1" inning "tarde" with suscription date "2012-11-01" and state "Accept"
		 And I log in as "martin" "martin"
		When I click in the "Suscription" link
    ...
    Scenario: See the list of reject suscription  
       Given student "martin" exists with password "martin"
		 ...
		 And a inning with name "tarde" and description "horario" in the course "2012-1"
		 And there are no suscription
		 And existe suscrition of student "martin" for course "2012-1" inning "tarde" with suscription date "2012-11-01" and state "Reject"
		 And I log in as "martin" "martin"
		When I click in the "Suscription" link
        Then I should see "Reject"
        
    Scenario: Suscribe and desapear de course and inning, unique suscribe pending for course
       Given student "martin" exists with password "martin"
		 And there are no courses
		 And there are no innings
		 And course "2012-1" exists
		 And a inning with name "tarde" and description "horario" in the course "2012-1"
		 And a inning with name "noche" and description "horario" in the course "2012-1"
		 And there are no suscription
		 And existe suscrition of student "martin" for course "2012-1" inning "tarde" with suscription date "2012-11-01" and state "Pending"
		 And I log in as "martin" "martin"
		When I click in the "Suscription" link

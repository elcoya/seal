Feature: As a Teacher I should be able to browse the files of the deliveries done by the students
    ...
    Scenario: Access the delivery explorer as a teacher
        Given Teacher "teacher" exists with password "teacher"
         ...
         When I am in the list page of delivery from "TP Intro" of course "2013-1"
         Then I should see a link to delivery with id "1" of course "2013-1"
    ...
    Scenario: Browse a certain delivery
        Given Teacher "teacher" exists with password "teacher"
         ...
         Then I should see a link to file "prueba.txt" of the delivery id "1" of course "2013-1"

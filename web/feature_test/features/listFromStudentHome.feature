Feature: As a student I want to see de courses where i am enrolled and the practices of this courses 
 	...
 	Scenario: No Course Enrolled
 		Given Student "martin" exists with password "martin"
 		 ...
 		 Then I should see "There are yet no innings in which you are enrolled"
	...
	Scenario: Enrolled in two courses, order by newest course
		Given Student "martin" exists with password "martin"
		  ...
		  And a inning with name "tarde" and description "horario" in the course "2012-1"
		  And a inning with name "tarde" and description "horario" in the course "2011-2"
		  And student "martin" exists in course "2012-1" inning "tarde" and in course "2011-2" inning "tarde" 
          And I log in as "martin" "martin"
